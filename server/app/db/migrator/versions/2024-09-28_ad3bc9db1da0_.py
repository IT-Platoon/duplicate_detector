...
def upgrade():
    ...
    op.create_index('ix_video_item_embedding', 'video_frame', ['embedding'], unique=False, postgresql_using='hnsw', postgresql_ops={'embedding': 'vector_cosine_ops'})
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index('ix_video_item_embedding', table_name='video_frame', postgresql_using='hnsw', postgresql_ops={'embedding': 'vector_cosine_ops'})
